...
function getallContactstats2($MJ_APIKEY_PUBLIC, $MJ_APIKEY_PRIVATE)
{
...
function findContact($MJ_APIKEY_PUBLIC, $MJ_APIKEY_PRIVATE, $email)
{
	$data = false;
	$mj = new \Mailjet\Client($MJ_APIKEY_PUBLIC, $MJ_APIKEY_PRIVATE);
	$response = $mj->get(Resources::$ContactGetcontactslists, ['id' => urlencode($email)]);
...
function findContactlist($MJ_APIKEY_PUBLIC, $MJ_APIKEY_PRIVATE,$ListID)
{
	$data = false;
	$mj = new \Mailjet\Client($MJ_APIKEY_PUBLIC, $MJ_APIKEY_PRIVATE);
